...
function structures.init()
  ...
  structures:register("PYLON",        { "CC NUMBER", "CC VALUE", "SLEW", "CHANNEL", "DEVICE" })
  structures:register("SWITCHBOARD",  { "INDEX", "CC COUNT", "CC VALUES", "TOPOGRAPHY", "CC NUMBER", "SLEW", "CHANNEL", "DEVICE" })
  ...
  structures:register("BEACON",       { "ID", "RETRIG", "MODE" })
end
